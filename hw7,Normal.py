...
stud1 = Student('Петров', 'Иван', 'Иванович', '6А', 'Иван', 'Фролов', 'Ирина', 'Романовна')
stud2 = Student('Сидорова', 'Анна', 'Ивановна', '6Б', 'Никита', 'Кириллович', 'Елена', 'Михеевна')
stud3 = Student('Ребко', 'Максим', 'Матвеевич', '7А', 'Матвей', 'Антонов', 'Ксения', 'Давидовна')
stud4 = Student('Иванова', 'Алёна', 'Романовна', '6А', 'Иларион', 'Брониславович', 'Розалия', 'Ильевна')
stud5 = Student('Гаврилова', 'Мария', 'Ильевна', '6Б', 'Илья', 'Михеев', 'Ефросиния', 'Якововна')
stud6 = Student('Шепкин', 'Богдан', 'Мирославович', '7А', 'Мирослав', 'Саввевич', 'Светлана', 'Игоревна')
stud7 = Student('Паршина', 'Нина', 'Павеловна', '6Б', 'Павел', 'Измаилович', 'Галина', 'Станиславовна')
stud8 = Student('Михайличенко', 'Евгения', 'Филипповна', '7А', 'Филипп', 'Сидорович', 'Вера', 'Родионовна')
stud9 = Student('Агафонов', 'Артем', 'Глебович', '7Б', 'Глеб', 'Петрович', 'Василиса', 'Семеновна')
stud10 = Student('Комягина', 'Арина', 'Геннадиевна', '7Б', 'Геннадий', 'Сергеевич', 'Юлия', 'Романовна')

teacher1 = Teacher('Андреева', 'Зинаида', 'Степановна', 'русский язык', '6А 6Б 7А 7Б')
teacher2 = Teacher('Шаронова', 'Арина', 'Петровна', 'математика', '6А 6Б 7А 7Б')
teacher3 = Teacher('Фролова', 'Екатерина', 'Тимуровна', 'физика', '6А 6Б')
teacher4 = Teacher('Летова', 'Марина', 'Филипповна', 'химия', '7А 7Б')
teacher5 = Teacher('Антиповский', 'Анатолий', 'Юрьевич', 'физкультура', '6А 6Б')
